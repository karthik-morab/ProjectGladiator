...
public class HotelElements {
    ...
    By e_in = By.cssSelector("span[data-testid='date_20_10_2021']");
    By e_out = By.cssSelector("span[data-testid='date_21_10_2021']");
    ...
    public void merge()
    {
     ExtentHtmlReporter  htmlreporter = new ExtentHtmlReporter(System.getProperty("C:\\Users\\Dell\\Desktop\\pro-prev_batch\\GladiatorGoibiboFinal\\GladiatorGoibiboFinal\\Gladiator11\\test-output")+"/ExtentReports.html");	
